...
class ResultPrinter_getTestInfo_Test extends TestCase
{
	...
	public function testDataProvider()
	{
		...
		$this->assertContains('<a href="?test=' . DIRECTORY_SEPARATOR . 'ResultPrinter_getTestInfo_Test.php::DataProvider+with+data+set+%22%22">ResultPrinter_getTestInfo :: DataProvider</a>', $content);
	}
